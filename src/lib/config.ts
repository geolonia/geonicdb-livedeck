 ...
 * 200名規模の負荷試験済みテナント `foss4g_hiroshima_2026` へ書き込む必要があるため、
 * テナント・API キーとも別建てにする（統合ポリシー geonicdb-livedeck-deck とは別の
 * integration key。Secrets Manager `geonicdb/foss4g-hiroshima-2026/contribution-key`）。
 */
